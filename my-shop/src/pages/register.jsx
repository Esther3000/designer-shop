...
const Register = () => {
  ...
  const handleRegister = (e) => {
    ...
    const configuration = {
      method: "post",
      url: "https://shop-site-backend.onrender.com/register",
      data: {
        username,
        email,
        password,
  ...
  return (
    ...
    <CardContent >
      ...
      <h1>Register</h1>
      {/* username */}
      <TextField fullWidth label='username' class="input-box" margin="normal" type="username"
            name="username"
            value={username}
      ...
      <h6>Already have a Netflix account? <Link to="/login">Sign In</Link></h6>
