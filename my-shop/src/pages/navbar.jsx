    ...
    <Box sx={{ flexGrow: 1}}>
        ...
        <Typography variant="img" component="div" class='netflix-logo'sx={{ flexGrow: 1,  }}>
         ...
         <Typography variant="h4" component="div" class= 'nav-buttons'sx={{ flexGrow: 2, display: "flex", flexDirection: "row"}}>
          ...
          <Button className="avatar-button"><img src="https://wallpapers.com/images/hd/netflix-profile-pictures-1000-x-1000-88wkdmjrorckekha.jpg" className="netflix-avatar"></img></Button>
